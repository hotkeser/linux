...
/*
 i nt ap*cie_bpcie_func_per_pci_func[BAIKAL_NUM_FUNCS] {
 4, 2, 7, 0, 1, 3, 5, 6
 }
 */
...
/* Relative to BAR4 */
/*
 # defin*e APCIE_RGN_RTC_BASE		0x0
...
/*
 # defin*e APCIE_RGN_PCIE_BASE		0x1c8000
...
/*
 # defin*e APCIE_REG_BAR(x)		(APCIE_RGN_PCIE_BASE + (x))
